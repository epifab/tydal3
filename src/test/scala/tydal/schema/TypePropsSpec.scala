...
object AreComparableSpec extends TypePropsSpec:
  ...
  summon[AreComparable[Literal[text], Column["hello", varchar]]]
  ...
  summon[AreComparable[Column["yo", nullable[text]], Literal[varchar]]]
  summon[AreComparable[Column["yo", text], Literal[nullable[varchar]]]               ]
  summon[AreComparable[Column["yo", nullable[text]], Literal[nullable[varchar]]]]
...
object AreComparableArraySpec extends TypePropsSpec:
  ...
  summon[AreComparableArray[Literal[array[text]], Column["hello", array[varchar]]]]
  ...
  summon[AreComparableArray[Column["yo", nullable[array[text]]], Literal[array[varchar]]]]
  summon[AreComparableArray[Column["yo", array[text]], Literal[nullable[array[varchar]]]]]
  summon[AreComparableArray[Column["yo", nullable[array[text]]], Literal[nullable[array[varchar]]]]]
...
object CanContainSpec extends TypePropsSpec:
  ...
  summon[CanContain[Literal[array[text]], Column["hello", varchar]]]
  ...
  summon[CanContain[Column["yo", nullable[array[text]]], Literal[varchar]]]
  summon[CanContain[Column["yo", array[text]], Literal[nullable[varchar]]]]
  summon[CanContain[Column["yo", nullable[array[text]]], Literal[nullable[varchar]]]]
